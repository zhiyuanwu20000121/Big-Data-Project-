...
y_val_pred_log = tree_model.predict(X_val)
...
y_test_pred_log = tree_model.predict(X_test)
...
plt.title('(Decision Tree Regressor) True vs Predicted Prices (Validation Set)')
plt.legend()
plt.savefig('true_vs_predicted_prices_val_decision_tree.png')
plt.show()
...
plt.title('(Decision Tree Regressor) True vs Predicted Prices with Reasonable Price Range (Test Set)')
plt.legend()
plt.savefig('true_vs_predicted_prices_test_decision_tree.png')
plt.show()
